    ...
    <main> 
        ...
        {submitted ? (
            ...
            <label className="block mb-5">
                ...
                <input {...register("name", {required: true})} className="shadow broder rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" placeholder="john Applessed" type="text"/>
            </label>
            <label className="block mb-5">
                <span className="text-gray-700">Email</span>
                <input {...register("email", {required: true})} className="shadow broder rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" placeholder="john Applessed" type="email" />
            </label>
            <label className="block mb-5">
